    ...
    if (loading) {
        return (
            <div className="flex items-center justify-center h-screen">
                <div className="text-xl">Loading region data...</div>
            </div>
        );
    }
    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen">
            ...
            <div className="mb-6">
                ...
                <h1 className="text-3xl font-bold text-gray-800">Region Dashboard</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                        <BarChart data={data.branches}>
                            ...
                            <Bar
                                ...
                                fill="#0088FE"
                                name="Revenue"
                                onClick={(entry) => handleBranchClick(entry.branchId)}
                ...
                {/* Contracts by Branch Bar Chart */}
                <div className="bg-white p-6 rounded-lg shadow">
                    <h3 className="text-lg font-semibold mb-4">Contracts by Branch</h3>
                    <ResponsiveContainer width="100%" height={300}>
                        <BarChart data={data.branches}>
                            <CartesianGrid strokeDasharray="3 3" />
                            <XAxis dataKey="branchName" angle={-45} textAnchor="end" height={100} />
            ...
            {/* Branches Table */}
            <div className="bg-white p-6 rounded-lg shadow">
                <h3 className="text-lg font-semibold mb-4">Branches Overview</h3>
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {data.branches.map((branch) => (
                                <tr key={branch.branchId} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{branch.branchHead}</td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right">{formatCurrency(branch.revenue)}</td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right">{branch.contracts}</td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right">{branch.customers}</td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right">{branch.deals}</td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right">{formatHP(branch.totalHP)}</td>
