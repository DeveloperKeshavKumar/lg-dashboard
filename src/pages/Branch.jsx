...
export default function Branch() {
    ...
    const filteredSummary = useMemo(() => {
        if (!filteredData) return { totalRevenue: 0, totalContracts: 0, totalCustomers: 0, totalDeals: 0, activeContracts: 0 };
        const activeContracts = filteredData.contracts.filter(c => c.custom_contract_status === "Active").length;
        return {
